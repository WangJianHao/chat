...
public class SenCommonResponse<T> {
     ...
     * @param message 提示信息
     */
    public static <T> SenCommonResponse<T> failed(Integer errorCode, String message) {
        return new SenCommonResponse<T>(errorCode, message, null);
    }
    ...
    public static <T> SenCommonResponse<T> validateFailed(String message) {
        return new SenCommonResponse<T>(BaseErrorCodeEnum.PARAM_VALID_FAIL.getCode(), message, null);
    }
